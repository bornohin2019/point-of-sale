        ...
        <div class="col-lg-4">
            <div class="card card-transparent card-block card-stretch card-height border-none">
                <div class="card-body p-0 mt-lg-2 mt-0">
                    <h3 class="mb-3">Meghdoot IT</h3>
                    <p class="mb-0 mr-4">Meghdoot IT's dashboard offers a seamless and intuitive view of key performance metrics and business processes, empowering smarter decisions with real-time insights.</p>
                </div>
            </div>
        </div>
        <div class="col-lg-8">
